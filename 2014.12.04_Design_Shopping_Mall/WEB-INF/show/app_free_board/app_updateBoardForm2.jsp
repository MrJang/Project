...
<body>
	...
	<form:form commandName = "board" enctype = "multipart/form-data">
		...
		<form:input path = "uploadfile" type = "file" cssClass = "normal" cssErrorClass = "errors"/><br/><br/>
		<input type = "submit" value = "등록"/>&nbsp;<input type = "reset" value = "리셋"/>　　　　　　　&nbsp;
		<input type = "button" class = "myButton3" value = "목록으로" onClick = "window.location = 'app_free_board2?pageNum=${param.pageNum}'">
	</form:form>
