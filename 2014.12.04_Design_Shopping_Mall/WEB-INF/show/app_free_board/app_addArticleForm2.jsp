...
<%-- 		<form:input path = "num" type = "hidden" cssClass = "normal" cssErrorClass = "errors"/> --%>
		...
		<input class = "myButton3" type = "submit" value = "등록"/>&nbsp;<input class = "myButton3" type = "reset" value = "리셋"/>　　　　　　　&nbsp;&nbsp;<input type="button" value="목록으로" onclick="window.location = 'app_free_board2?pageNum=1'">
	</form:form>
</body>
</html>