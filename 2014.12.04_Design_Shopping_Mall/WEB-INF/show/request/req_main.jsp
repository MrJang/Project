...
<body onload="scroll_skin_load();">
	<form:form commandName="request">
		<table width="100%">
			<tr>
				<td colspan="2" style="background: #000000; color: #FFFFFF;">
					<center>의뢰할 디자이너 선정</center>
				</td>
			</tr>
			<tr>
				<td width="50%">
					<form:hidden path="req_receiver" value="${param.selected_designer}" id="receiver" />
					<div id="receiver_view" style="font-size: 15px; width : 98.8%; height: 20px; border: 3px solid #000000;">
						<c:choose>
				...
				<td width="50%">
					<select style="width: 100%; font-size: 10;">
						<option>모든 디자이너</option>
						<option>관심 디자이너</option>
						<option>업적 순 디자이너</option>
					</select>
				</td>
			</tr>
		</table>
		<table width="100%" style="height: 600px;">
			<tr>
				<td colspan="2" width="50%" style="border: 3px solid #000000;">
					<div id="scroll_skin" class="scroll_skin">
						<img src='../profile/${param.selected_designer}.jpg' id='img' alt='디자이너 사진' width='350px'></img>
					</div>
				</td>
				<td width="50%" class="b0px">
					<select id="selectBox" size="3" style="width: 380px; height: 100%;" onchange="changeFunc();">
						<option id="none" value="none" disabled="disabled">-------------------------------------디자이너선택---------------------------------</option>
							<c:forEach var="member" items="${list}">
								<option value="${member.mem_id}">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${member.mem_id}</option>
							</c:forEach>
					</select>
				</td>
			</tr>
...
<!-- 						<div class = "requestt" style = "vertical-align : middle;  width : 98%; height : 94%;" onclick = "window.location = 'req_list?pageNum=1'"><b style = "font-size: 22px; vertical-align: middle;">나의 의뢰 목록</b></div> -->
						<input type = "button" class = "request" style = "width : 100%; height : 95%; font-size: 22px; font-weight: bold;" onclick = "window.location = 'req_list?pageNum=1'"  value = "나의 의뢰 목록" />
